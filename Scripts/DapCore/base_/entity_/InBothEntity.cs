...
namespace angeldnd.dap {
    public abstract class InBothEntity<TO> : InBothElement<TO>, IEntity
                                            where TO : IOwner {
        //SILP:IN_BOTH_MIXIN_CONSTRUCTOR(InBothEntity)
        protected InBothEntity(TO owner, string path, Pass pass) : base(owner, path, pass) {  //__SILP__
        }                                                                                     //__SILP__
                                                                                              //__SILP__
        protected InBothEntity(TO owner, int index, Pass pass) : base(owner, index, pass) {   //__SILP__
        }                                                                                     //__SILP__
