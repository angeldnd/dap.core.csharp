...
namespace angeldnd.dap {
    public abstract class TableInTableEntity<TO, T> : TableInTable<TO, T>, IEntity
                                                        where TO : ITable
                                                        where T : class, IInTableElement {
        //SILP:IN_TABLE_MIXIN_CONSTRUCTOR(TableInTableEntity)
        protected TableInTableEntity(TO owner, int index, Pass pass) : base(owner, index, pass) {  //__SILP__
        }                                                                                          //__SILP__
