...
namespace angeldnd.dap {
    public abstract class TreeInBothEntity<TO, T> : TreeInBoth<TO, T>, IEntity
                                                        where TO : IOwner
                                                        where T : class, IInTreeElement {
        //SILP:IN_BOTH_MIXIN_CONSTRUCTOR(TreeInBothEntity)
        protected TreeInBothEntity(TO owner, string path, Pass pass) : base(owner, path, pass) {  //__SILP__
        }                                                                                         //__SILP__
                                                                                                  //__SILP__
        protected TreeInBothEntity(TO owner, int index, Pass pass) : base(owner, index, pass) {   //__SILP__
        }                                                                                         //__SILP__
