...
namespace angeldnd.dap {
    public abstract class InTreeEntity<TO> : InTreeElement<TO>, IEntity
                                            where TO : ITree {
        //SILP:IN_TREE_MIXIN_CONSTRUCTOR(InTreeEntity)
        protected InTreeEntity(TO owner, string path, Pass pass) : base(owner, path, pass) {  //__SILP__
        }                                                                                     //__SILP__
