...
namespace angeldnd.dap {
    public abstract class TreeInTableEntity<TO, T> : TreeInTable<TO, T>, IEntity
                                                        where TO : ITable
                                                        where T : class, IInTreeElement {
        //SILP:IN_TABLE_MIXIN_CONSTRUCTOR(TreeInTableEntity)
        protected TreeInTableEntity(TO owner, int index, Pass pass) : base(owner, index, pass) {  //__SILP__
        }                                                                                         //__SILP__
