...
namespace angeldnd.dap {
    public abstract class TableInTreeEntity<TO, T> : TableInTree<TO, T>, IEntity
                                                        where TO : ITree
                                                        where T : class, IInTableElement {
        //SILP:IN_TREE_MIXIN_CONSTRUCTOR(TableInTreeEntity)
        protected TableInTreeEntity(TO owner, string path, Pass pass) : base(owner, path, pass) {  //__SILP__
        }                                                                                          //__SILP__
