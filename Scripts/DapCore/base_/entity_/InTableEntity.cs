...
namespace angeldnd.dap {
    public abstract class InTableEntity<TO> : InTableElement<TO>, IEntity
                                            where TO : ITable {
        //SILP:IN_TABLE_MIXIN_CONSTRUCTOR(InTableEntity)
        protected InTableEntity(TO owner, int index, Pass pass) : base(owner, index, pass) {  //__SILP__
        }                                                                                     //__SILP__
