...
namespace angeldnd.dap {
    public abstract class TreeInTreeEntity<TO, T> : TreeInTree<TO, T>, IEntity
                                                        where TO : ITree
                                                        where T : class, IInTreeElement {
        //SILP:IN_TREE_MIXIN_CONSTRUCTOR(TreeInTreeEntity)
        protected TreeInTreeEntity(TO owner, string path, Pass pass) : base(owner, path, pass) {  //__SILP__
        }                                                                                         //__SILP__
