...
namespace angeldnd.dap {
    public abstract class TreeInTreeContext<TO, T> : TreeInTree<TO, T>, IInTreeContext, ITreeContext
        ...
        public TreeInTreeContext(TO owner, string path, Pass pass) : base(owner, path, pass) {
        //SILP: CONTEXT_MIXIN()
