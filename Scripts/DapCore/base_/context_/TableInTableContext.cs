...
namespace angeldnd.dap {
    public abstract class TableInTableContext<TO, T> : TableInTable<TO, T>, IInTableContext, ITableContext
                                                        where TO : ITableContext
                                                        where T : class, IInTableContext {
        public TableInTableContext(TO owner, int index, Pass pass) : base(owner, index, pass) {
        //SILP: CONTEXT_MIXIN()
