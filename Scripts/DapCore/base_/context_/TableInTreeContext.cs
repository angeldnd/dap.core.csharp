...
namespace angeldnd.dap {
    public abstract class TableInTreeContext<TO, T> : TableInTree<TO, T>, IInTreeContext, ITableContext
                                                        where TO : ITreeContext
                                                        where T : class, IInTableContext {
        public TableInTreeContext(TO owner, string path, Pass pass) : base(owner, path, pass) {
        //SILP: CONTEXT_MIXIN()
