...
namespace angeldnd.dap {
    public abstract class TreeInBothContext<TO, T> : TreeInBoth<TO, T>, IContext, ITreeContext
                                                        where TO : IContext
        ...
        //SILP:IN_BOTH_CONTEXT_MIXIN(TreeInBothContext)
        private TreeInBothContext(TO owner, string path, Pass pass) : base(owner, path, pass) {  //__SILP__
            ...
            _Manners = new Manners(this, sectionPass);                                           //__SILP__
                                                                                                 ...
                                                                                                 //__SILP__
        private TreeInBothContext(TO owner, int index, Pass pass) : base(owner, index, pass) {   //__SILP__
            Pass sectionPass = Pass.ToOpen(Pass);                                                //__SILP__
                                                                                                 //__SILP__
            _Properties = new Properties(this, sectionPass);                                     //__SILP__
            _Channels = new Channels(this, sectionPass);                                         //__SILP__
