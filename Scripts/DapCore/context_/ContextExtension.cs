...
namespace angeldnd.dap {
    public static class ContextExtension {
        public static IProperty AddProperty(this IContext context, string path, Pass pass, bool open, Data data) {
            return context.Properties.Add(path, pass, open, data);
        }
        ...
        public static BoolProperty AddBool(this IContext context, string path, Pass pass, bool val) {  //__SILP__
            return context.Properties.AddBool(path, pass, val);                                        //__SILP__
        }                                                                                              //__SILP__
                                                                                                       //__SILP__
        ...
        public static bool GetBool(this IContext context, string path, bool defaultValue) {            //__SILP__
            return context.Properties.GetBool(path, defaultValue);                                     //__SILP__
                                                                                                       ...
                                                                                                       //__SILP__
        public static bool SetBool(this IContext context, string path, Pass pass, bool value) {        //__SILP__
            return context.Properties.SetBool(path, pass, value);                                      //__SILP__
        }                                                                                              //__SILP__
                                                                                                       //__SILP__
        ...
        public static IntProperty AddInt(this IContext context, string path, Pass pass, int val) {  //__SILP__
            return context.Properties.AddInt(path, pass, val);                                      //__SILP__
        }                                                                                           //__SILP__
                                                                                                    //__SILP__
        ...
        public static int GetInt(this IContext context, string path, int defaultValue) {            //__SILP__
            return context.Properties.GetInt(path, defaultValue);                                   //__SILP__
                                                                                                    ...
                                                                                                    //__SILP__
        public static bool SetInt(this IContext context, string path, Pass pass, int value) {       //__SILP__
            return context.Properties.SetInt(path, pass, value);                                    //__SILP__
        }                                                                                           //__SILP__
                                                                                                    //__SILP__
        ...
        public static LongProperty AddLong(this IContext context, string path, Pass pass, long val) {  //__SILP__
            return context.Properties.AddLong(path, pass, val);                                        //__SILP__
        }                                                                                              //__SILP__
                                                                                                       //__SILP__
        ...
        public static long GetLong(this IContext context, string path, long defaultValue) {            //__SILP__
            return context.Properties.GetLong(path, defaultValue);                                     //__SILP__
                                                                                                       ...
                                                                                                       //__SILP__
        public static bool SetLong(this IContext context, string path, Pass pass, long value) {        //__SILP__
            return context.Properties.SetLong(path, pass, value);                                      //__SILP__
        }                                                                                              //__SILP__
                                                                                                       //__SILP__
        ...
        public static FloatProperty AddFloat(this IContext context, string path, Pass pass, float val) {  //__SILP__
            return context.Properties.AddFloat(path, pass, val);                                          //__SILP__
        }                                                                                                 //__SILP__
                                                                                                          //__SILP__
        ...
        public static float GetFloat(this IContext context, string path, float defaultValue) {            //__SILP__
            return context.Properties.GetFloat(path, defaultValue);                                       //__SILP__
                                                                                                          ...
                                                                                                          //__SILP__
        public static bool SetFloat(this IContext context, string path, Pass pass, float value) {         //__SILP__
            return context.Properties.SetFloat(path, pass, value);                                        //__SILP__
        }                                                                                                 //__SILP__
                                                                                                          //__SILP__
        ...
        public static DoubleProperty AddDouble(this IContext context, string path, Pass pass, double val) {  //__SILP__
            return context.Properties.AddDouble(path, pass, val);                                            //__SILP__
        }                                                                                                    //__SILP__
                                                                                                             //__SILP__
        ...
        public static double GetDouble(this IContext context, string path, double defaultValue) {            //__SILP__
            return context.Properties.GetDouble(path, defaultValue);                                         //__SILP__
                                                                                                             ...
                                                                                                             //__SILP__
        public static bool SetDouble(this IContext context, string path, Pass pass, double value) {          //__SILP__
            return context.Properties.SetDouble(path, pass, value);                                          //__SILP__
        }                                                                                                    //__SILP__
                                                                                                             //__SILP__
        ...
        public static StringProperty AddString(this IContext context, string path, Pass pass, string val) {  //__SILP__
            return context.Properties.AddString(path, pass, val);                                            //__SILP__
        }                                                                                                    //__SILP__
                                                                                                             //__SILP__
        ...
        public static string GetString(this IContext context, string path, string defaultValue) {            //__SILP__
            return context.Properties.GetString(path, defaultValue);                                         //__SILP__
                                                                                                             ...
                                                                                                             //__SILP__
        public static bool SetString(this IContext context, string path, Pass pass, string value) {          //__SILP__
            return context.Properties.SetString(path, pass, value);                                          //__SILP__
        }                                                                                                    //__SILP__
                                                                                                             //__SILP__
        ...
        public static DataProperty AddData(this IContext context, string path, Pass pass, Data val) {  //__SILP__
            return context.Properties.AddData(path, pass, val);                                        //__SILP__
        }                                                                                              //__SILP__
                                                                                                       //__SILP__
        ...
        public static Data GetData(this IContext context, string path, Data defaultValue) {            //__SILP__
            return context.Properties.GetData(path, defaultValue);                                     //__SILP__
                                                                                                       ...
                                                                                                       //__SILP__
        public static bool SetData(this IContext context, string path, Pass pass, Data value) {        //__SILP__
            return context.Properties.SetData(path, pass, value);                                      //__SILP__
        }                                                                                              //__SILP__
                                                                                                       //__SILP__
