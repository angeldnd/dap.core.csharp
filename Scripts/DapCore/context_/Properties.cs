    ...
    public class Properties : SecurableEntityAspect {
        ...
        public bool RemoveBoolValueChecker(string path, ValueChecker<bool> checker) {                                              //__SILP__
            return RemoveBoolValueChecker(path, checker);                                                                          //__SILP__
                                                                                                                                   ...
                                                                                                                                   //__SILP__
        public BoolBlockValueChecker AddBoolBlockValueChecker(string path, Pass pass, BoolBlockValueChecker.CheckerBlock block) {  //__SILP__
            BoolProperty p = Get<BoolProperty>(path);                                                                              //__SILP__
            if (p != null) {                                                                                                       //__SILP__
        ...
        public BoolBlockValueChecker AddBoolBlockValueChecker(string path, BoolBlockValueChecker.CheckerBlock block) {             //__SILP__
            return AddBoolBlockValueChecker(path, block);                                                                          //__SILP__
        }                                                                                                                          //__SILP__
                                                                                                                                   //__SILP__
        ...
        public bool RemoveIntValueChecker(string path, ValueChecker<int> checker) {                                             //__SILP__
            return RemoveIntValueChecker(path, checker);                                                                        //__SILP__
                                                                                                                                ...
                                                                                                                                //__SILP__
        public IntBlockValueChecker AddIntBlockValueChecker(string path, Pass pass, IntBlockValueChecker.CheckerBlock block) {  //__SILP__
            IntProperty p = Get<IntProperty>(path);                                                                             //__SILP__
            if (p != null) {                                                                                                    //__SILP__
                return p.AddBlockValueChecker(pass, block);                                                                     //__SILP__
            } else {                                                                                                            //__SILP__
        ...
        public IntBlockValueChecker AddIntBlockValueChecker(string path, IntBlockValueChecker.CheckerBlock block) {             //__SILP__
            return AddIntBlockValueChecker(path, block);                                                                        //__SILP__
        }                                                                                                                       //__SILP__
                                                                                                                                //__SILP__
        ...
        public bool RemoveLongValueChecker(string path, ValueChecker<long> checker) {                                              //__SILP__
            return RemoveLongValueChecker(path, checker);                                                                          //__SILP__
                                                                                                                                   ...
                                                                                                                                   //__SILP__
        public LongBlockValueChecker AddLongBlockValueChecker(string path, Pass pass, LongBlockValueChecker.CheckerBlock block) {  //__SILP__
            LongProperty p = Get<LongProperty>(path);                                                                              //__SILP__
            if (p != null) {                                                                                                       //__SILP__
                return p.AddBlockValueChecker(pass, block);                                                                        //__SILP__
            } else {                                                                                                               //__SILP__
        ...
        public LongBlockValueChecker AddLongBlockValueChecker(string path, LongBlockValueChecker.CheckerBlock block) {             //__SILP__
            return AddLongBlockValueChecker(path, block);                                                                          //__SILP__
        }                                                                                                                          //__SILP__
                                                                                                                                   //__SILP__
        ...
        public bool RemoveFloatValueChecker(string path, ValueChecker<float> checker) {                                               //__SILP__
            return RemoveFloatValueChecker(path, checker);                                                                            //__SILP__
                                                                                                                                      ...
                                                                                                                                      //__SILP__
        public FloatBlockValueChecker AddFloatBlockValueChecker(string path, Pass pass, FloatBlockValueChecker.CheckerBlock block) {  //__SILP__
            FloatProperty p = Get<FloatProperty>(path);                                                                               //__SILP__
            if (p != null) {                                                                                                          //__SILP__
                return p.AddBlockValueChecker(pass, block);                                                                           //__SILP__
            } else {                                                                                                                  //__SILP__
        ...
        public FloatBlockValueChecker AddFloatBlockValueChecker(string path, FloatBlockValueChecker.CheckerBlock block) {             //__SILP__
            return AddFloatBlockValueChecker(path, block);                                                                            //__SILP__
        }                                                                                                                             //__SILP__
                                                                                                                                      //__SILP__
        ...
        public bool RemoveDoubleValueChecker(string path, ValueChecker<double> checker) {                                                //__SILP__
            return RemoveDoubleValueChecker(path, checker);                                                                              //__SILP__
                                                                                                                                         ...
                                                                                                                                         //__SILP__
        public DoubleBlockValueChecker AddDoubleBlockValueChecker(string path, Pass pass, DoubleBlockValueChecker.CheckerBlock block) {  //__SILP__
            DoubleProperty p = Get<DoubleProperty>(path);                                                                                //__SILP__
            if (p != null) {                                                                                                             //__SILP__
                return p.AddBlockValueChecker(pass, block);                                                                              //__SILP__
            } else {                                                                                                                     //__SILP__
        ...
        public DoubleBlockValueChecker AddDoubleBlockValueChecker(string path, DoubleBlockValueChecker.CheckerBlock block) {             //__SILP__
            return AddDoubleBlockValueChecker(path, block);                                                                              //__SILP__
        }                                                                                                                                //__SILP__
                                                                                                                                         //__SILP__
        ...
        public bool RemoveStringValueChecker(string path, ValueChecker<string> checker) {                                                //__SILP__
            return RemoveStringValueChecker(path, checker);                                                                              //__SILP__
                                                                                                                                         ...
                                                                                                                                         //__SILP__
        public StringBlockValueChecker AddStringBlockValueChecker(string path, Pass pass, StringBlockValueChecker.CheckerBlock block) {  //__SILP__
            StringProperty p = Get<StringProperty>(path);                                                                                //__SILP__
            if (p != null) {                                                                                                             //__SILP__
                return p.AddBlockValueChecker(pass, block);                                                                              //__SILP__
            } else {                                                                                                                     //__SILP__
        ...
        public StringBlockValueChecker AddStringBlockValueChecker(string path, StringBlockValueChecker.CheckerBlock block) {             //__SILP__
            return AddStringBlockValueChecker(path, block);                                                                              //__SILP__
        }                                                                                                                                //__SILP__
                                                                                                                                         //__SILP__
        ...
        public bool RemoveDataValueChecker(string path, ValueChecker<Data> checker) {                                              //__SILP__
            return RemoveDataValueChecker(path, checker);                                                                          //__SILP__
                                                                                                                                   ...
                                                                                                                                   //__SILP__
        public DataBlockValueChecker AddDataBlockValueChecker(string path, Pass pass, DataBlockValueChecker.CheckerBlock block) {  //__SILP__
            DataProperty p = Get<DataProperty>(path);                                                                              //__SILP__
            if (p != null) {                                                                                                       //__SILP__
                return p.AddBlockValueChecker(pass, block);                                                                        //__SILP__
            } else {                                                                                                               //__SILP__
        ...
        public DataBlockValueChecker AddDataBlockValueChecker(string path, DataBlockValueChecker.CheckerBlock block) {             //__SILP__
            return AddDataBlockValueChecker(path, block);                                                                          //__SILP__
        }                                                                                                                          //__SILP__
                                                                                                                                   //__SILP__
