...
namespace angeldnd.dap {
    public abstract class LogWriter : ILogger {
        ...
        protected LogWriter(int ignoreStackTraceCount) {
    ...
    public sealed class DefaultLogWriter : LogWriter {
        public DefaultLogWriter(int ignoreStackTraceCount) : base(ignoreStackTraceCount) {
        }
    ...
    public sealed class DebugLogWriter : LogWriter {
        public DebugLogWriter(int ignoreStackTraceCount) : base(ignoreStackTraceCount) {
        }
