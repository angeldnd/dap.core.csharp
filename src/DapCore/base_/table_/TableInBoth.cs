...
namespace angeldnd.dap {
    public abstract class TableInBoth<TO, T> : TableElement<TO, T>, IInDictElement, IInTableElement
                                                        where TO : class, IOwner
                                                        where T : class, IInTableElement {
        //SILP:IN_BOTH_MIXIN(TableInBoth)
        protected TableInBoth(TO owner, string key) : base(owner, key) {    //__SILP__
        }                                                                   //__SILP__
                                                                            //__SILP__
        protected TableInBoth(TO owner, int index) : base(owner) {          //__SILP__
